...
### v2.0
- Heatmap клавиатуры - ASCII-визуализация QWERTY с цветовой кодировкой ошибок
- Топ-10 проблемных символов с автогенерацией персонального упражнения
- Данные heatmap накапливаются между сессиями в `~/.typecode/heatmap.txt`
- 33 теста в 7 тест-файлах, `make coverage` с минимальным порогом 60%
